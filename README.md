...
Pasos para Configurar el Proyecto
  ...
  1. Configurar el Servidor Local con XAMPP
    1.1Abre XAMPP y ejecuta el servidor Apache y MySQL.
  2. Importar la Base de Datos en phpMyAdmin
    2.1 Abre tu navegador y ve a http://localhost/phpmyadmin.
    2.2 Crea una nueva base de datos:
    2.3 Haz clic en Nueva en el menú de la izquierda.
    2.4 Nombra la base de datos como portfolio y haz clic en Crear.
    2.5 Importa el archivo portfolio.sql:
    2.6 Con la base de datos portfolio seleccionada, ve a la pestaña Importar.
    2.7 Haz clic en Seleccionar archivo y elige el archivo portfolio.sql incluido en este proyecto.
    2.8 Haz clic en Continuar para importar la estructura y los datos de la base de datos.
  3. Ubicar los Archivos del Proyecto en la Carpeta de XAMPP
    3.1 Coloca los archivos del proyecto (incluyendo portfolio.php, config.php, proyectos.php, insert_proyecto.php, y los directorios images y js) dentro de la carpeta htdocs de tu instalación de XAMPP.
  4. Configurar el Archivo config.php
    4.1 Asegúrate de que el archivo config.php tenga la configuración correcta para conectar con la base de datos portfolio. Esto incluye definir el nombre de usuario y la contraseña de MySQL, y asegurarse de que el nombre de la base de      datos sea correcto.
  5. Verificar la Conexión y Funcionamiento
    5.1 Abre el navegador y accede a http://localhost/Página%20Personal%20Paula%20Ramírez/Portfolio.php (ajusta la URL según el nombre de la carpeta en htdocs si has elegido otro nombre).
    5.2 Deberías ver la página de portfolio con los proyectos cargados desde la base de datos.
